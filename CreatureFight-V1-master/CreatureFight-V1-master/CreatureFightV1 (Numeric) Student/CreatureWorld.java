 ...
 * 
 * Name: Alex Hackbart
 * Course: PTEC SoftWare Development
 * Teacher: Mr. Hardman
...
public class CreatureWorld extends World
{
    ...
    public void act()
    {
        ...
        // TODO (34): If playerOneCreature's health bar has a current health less than or equal to 0...
         ...
         else if( playerTwoCreature.getHealthBar().getCurrent() <= 0 )
         {
    ...
    /**
     * 
     * prepareCreatures adds the two creatures and their respective butons to
     * the world
     * 
     * @param There are no parameters
     * @return Nothing is returned
     ...
     */
     ...
     /**
      * getPlayerOne returns the player one creature
      * 
      * @param There are no parameters
      * @return Creature is returned
      * 
      */
     ...
     /**
      * getPlayerTwo returns the player two creature 
      * 
      * @param There are no parameters
      * @return Creature is returned
      * 
