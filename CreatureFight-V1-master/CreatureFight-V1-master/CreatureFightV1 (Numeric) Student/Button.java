...
public class Button extends Actor
{
    ...
    public void act() 
    {
        ...
        Creature enemy;
      //If the first Creature object in a 200 pixel range has a playerOwnership of 1
    if (getObjectsInRange(200, Creature.class).get(0).getPlayerOwner() == 1)
    {
        //Get player two from the world and store it in enemy
        enemy = world.getPlayerTwo();  
        //Get player one from the world and store it in enemy
    }
        else
        {
